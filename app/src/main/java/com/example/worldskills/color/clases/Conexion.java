package com.example.worldskills.color.clases;
...
public class Conexion extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            db.execSQL("INSERT INTO puntuacion (puntaje, intentos, milisegundos) VALUES (2, 3, 3000)");
            db.execSQL("INSERT INTO puntuacion (puntaje, intentos, milisegundos) VALUES (3, 3, 3000)");
